...
// under ctf/packages/web/app/api/socket-relay/admin/*. Admin access is enforced
// server-side; a 401/403 surfaces as an "admins only" notice in the screen.
//
// Mirrored endpoints:
//   GET    /api/socket-relay/admin/requests          (paged request list)
//   DELETE /api/socket-relay/admin/requests/:id       (delete a request — destructive)
//   GET    /api/socket-relay/admin/fulfillments        (fulfillment list)
//
...
const ADMIN_API_BASE = '/api/socket-relay/admin';
