...
// GET /api/socket-relay/my-fulfillments so the Direct Line can show context; both are optional
...
// again. Mirrors the web POST /api/socket-relay/requests/:id/repost; returns the refreshed request.
