...
function makeStyles(t: ThemeTokens, brand: string) {
  ...
  return StyleSheet.create({
    ...
    intro: { fontSize: 13, color: t.textSecondary, lineHeight: 20, marginBottom: 18 },
    ...
    rowMeta: { fontSize: t.isComic ? 10 : 11, color: t.textMuted, lineHeight: 15, marginTop: 1 },
    ...
    unblockText: { color: brand, fontSize: 13, fontWeight: '600' },
    ...
    emptySub: { fontSize: 13, color: t.textSecondary, lineHeight: 20, textAlign: 'center' },
