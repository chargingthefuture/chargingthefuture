...
import { FAINT, SUBTLE, TEXT } from "./sr-shared";
    ...
    <aside style={{ width: 240, background: t.HEADER, borderRight: "1px solid rgba(255,255,255,0.06)", display: "flex", flexDirection: "column", flexShrink: 0 }}>
      <div style={{ padding: "20px 16px 12px" }}>
        ...
        <div style={{ position: "relative" }}>
          ...
          <input value={search} onChange={(e) => onSearch(e.target.value)} placeholder="Search requests…" style={{ width: "100%", padding: "7px 10px 7px 30px", background: t.INPUT_BG, border: "1px solid rgba(255,255,255,0.06)", borderRadius: 8, fontSize: 13, color: t.SUBTLE, outline: "none", boxSizing: "border-box" }} />
        </div>
      </div>
