...
import { STATUS_COLOR, TRACK_COLORS, getLevelUpTokens, type Cohort, type LevelUpTokens } from "./lu-shared";

function enrollButtonView(t: LevelUpTokens, isEnrolled: boolean, isEnrolling: boolean, isFull: boolean) {
...
function cohortView(t: LevelUpTokens, cohort: Cohort) {
