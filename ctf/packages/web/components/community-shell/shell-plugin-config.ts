...
const PLUGIN_VISUALS: Record<string, PluginVisuals> = {
  ...
  lighthouse: { emoji: '🏠', color: '#60A5FA', bg: '#1c1407' },
  trusttransport: { emoji: '📦', color: '#38BDF8', bg: '#1c0a03' },
  'trust-transport': { emoji: '📦', color: '#38BDF8', bg: '#1c0a03' },
  directory: { emoji: '📇', color: '#93C5FD', bg: '#0c1a3d' },
  foundation: { emoji: '🪛', color: '#F59E0B', bg: '#1c0505' },
  'peer-programming': { emoji: '🏘️', color: '#6EE7B7', bg: '#150d2e' },
  'gross-domestic-product': { emoji: '🗺️', color: '#06B6D4', bg: '#011c26' },
  'service-credits': { emoji: '⚙️', color: '#A855F7', bg: '#1c1200' },
  workforce: { emoji: '💼', color: '#F97316', bg: '#0e0f30' },
  gentlepulse: { emoji: '💚', color: '#34D399', bg: '#011c1a' },
  mood: { emoji: '😁', color: '#4ADE80', bg: '#1c0416' },
  socketrelay: { emoji: '🔂', color: '#FB923C', bg: '#1c0409' },
  'skills-hunt': { emoji: '🎓', color: '#FBBF24', bg: '#130d2e' },
  'feed-announcements': { emoji: '📢', color: '#FB923C', bg: '#1c0e03' },
  'skills-taxonomy': { emoji: '🧩', color: '#818CF8', bg: '#041a0f' },
  'weekly-performance': { emoji: '📊', color: '#6366F1', bg: '#01162e' },
  clicklog: { emoji: '📍', color: '#EC4899', bg: '#f5f5fa' },
};
