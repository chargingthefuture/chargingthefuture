      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
          ...
          <div style={{ padding: '16px 16px 10px', borderBottom: `1px solid ${BORDER}` }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
              ...
              <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: 5, background: `${COLOR}15`, border: `1px solid ${COLOR}30`, borderRadius: 20, padding: '3px 10px' }}>
                ...
                <span style={{ fontSize: 11, color: COLOR, fontWeight: 600 }}>LIVE</span>
              </div>
            </div>
        ...
        <main style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
          ...
          <div style={{ padding: '20px 32px 16px', borderBottom: `1px solid ${BORDER}` }}>
            ...
            <div style={{ fontSize: 20, fontWeight: 800, color: TEXT, lineHeight: 1.3 }}>Live audio rooms for survivors</div>
            <div style={{ fontSize: 13, color: SUBTLE, marginTop: 4 }}>Listen in to public rooms for free. Sign in to speak, react, or host your own.</div>
          </div>
          ...
          <div style={{ flex: 1, overflowY: 'auto', padding: '24px 32px' }}>
            ...
            <div style={{ borderRadius: 12, border: `1px solid ${COLOR}25`, background: `${COLOR}08`, padding: '14px 20px', display: 'flex', alignItems: 'center', gap: 14 }}>
              ...
              <div style={{ flex: 1 }}>
                <div style={{ fontSize: 13, fontWeight: 600, color: TEXT }}>You&apos;re browsing as a guest</div>
      ...
      <div style={{ margin: '10px 12px 0', borderRadius: 14, border: `1px solid ${COLOR}30`, background: `${COLOR}06`, padding: '14px', flexShrink: 0 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 8 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 4, background: `${COLOR}15`, border: `1px solid ${COLOR}30`, borderRadius: 20, padding: '2px 8px' }}>
            ...
            <span style={{ fontSize: 10, color: COLOR, fontWeight: 700 }}>LIVE AUDIO</span>
          </div>
        </div>
