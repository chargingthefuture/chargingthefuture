...
// Real data only: every value comes from GET /api/levelup/wallet.
// LevelUp is grant-only ("earn or earn nothing"), so the wallet view returns
// availableBalance, levelupEscrowedBalance, totalEarned, and a positive-only
