        ...
        {isAdmin && (
          <>
            ...
            {TRAINER_TOOLS.map(({ icon: Icon, label }) => (
              <a key={label} href="/admin/levelup" style={{ display: "flex", alignItems: "center", gap: 10, padding: "9px 10px", borderRadius: 8, marginBottom: 2, cursor: "pointer", color: SUBTLE, fontSize: 13, textDecoration: "none" }}>
                <Icon size={15} />
                {label}
              </a>
            ))}
