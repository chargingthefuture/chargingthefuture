      ...
      <div style={{ maxWidth: 920, margin: '0 auto', padding: '24px 16px 48px' }}>
        ...
        {tab === 'incidents' ? (
          ...
          <div style={{ padding: '16px', borderRadius: 12, background: t.SURFACE, border: `1px solid ${t.BORDER_SOLID}` }}>
            ...
            <button type="button" disabled={busy} onClick={() => void saveMarketConfig()} style={{ marginTop: 4, padding: '11px 18px', borderRadius: 10, background: busy ? `${t.ACCENT}66` : t.ACCENT, border: 'none', color: '#04243a', fontSize: 14, fontWeight: 800, cursor: busy ? 'not-allowed' : 'pointer' }}>
