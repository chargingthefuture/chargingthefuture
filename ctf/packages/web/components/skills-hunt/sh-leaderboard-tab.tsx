...
export function SkillsHuntLeaderboardTab({
  ...
  return (
    <>
      ...
      <div style={{ fontSize: 14, color: t.MUTED, marginBottom: 4 }}>Ranked by accepted points · tie-break: first-match count, then earliest submission</div>
      <div style={{ fontSize: 12, color: t.FAINT, marginBottom: 20 }}>Pending points (⏳) convert to accepted points after admin review.</div>
