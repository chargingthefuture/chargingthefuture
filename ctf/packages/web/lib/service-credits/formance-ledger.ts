...
// Non-throwing config report for the admin status panel (getFormanceConfig throws when unset, which
// is correct for the write path but not for a status read). Mirrors the same demo-vs-prod ledger choice.
