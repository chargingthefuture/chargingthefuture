...
export async function reviewSubmission(
  ...
  return withDbTransaction(async (client) => {
    ...
    if (status === 'accepted') {
      ...
      // Mission progress recompute on accept. Notification fan-out for newly
      // completed missions is a Wave 2 follow-up; the call here only
      // updates progress + completion timestamps.
