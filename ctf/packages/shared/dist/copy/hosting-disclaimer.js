...
export const HOSTING_NOT_ENDORSEMENT = 'A slot is taken, not granted. Any approved member can book an open time and write their own '
    + 'description, nobody reviews it first, and a name here is not a recommendation from this project. '
    + 'The rules still apply in the room, and an account goes for breaking them.';
/** The short form, for a card with no room for the full statement. */
export const HOSTING_NOT_ENDORSEMENT_SHORT = 'Hosts book their own slots. A name here is not a recommendation, and the rules still apply in the room.';
