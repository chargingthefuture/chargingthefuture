...
This index is the Rule 114 baseline artifact map for coding readiness.
...
| `gentlepulse`            | `ctf/docs/contracts/GENTLEPULSE_PROFILE_AND_DELETION_CONTRACT.md`        | Present |
