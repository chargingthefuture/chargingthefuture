...
- Table/entity: `trust_transport_trip_requests`
...
- Table/entity: `trust_transport_trip_events`
...
- Table/entity: `trust_transport_safety_flags`
...
- Table/entity: `trust_transport_deletion_events`
...
- Delete immediately:
  - `trust_transport_user_extension`
...
- Retain for compliance/fraud/finance:
  ...
  - `trust_transport_deletion_events`
...
- Recreated defaults:
  - new `trust_transport_user_extension` with default safety preferences
...
- Service delete endpoint:
  - `DELETE /api/account/trust-transport-profile` (planned)
