...
3. Authenticated star rating submission (1â€“5) with aggregate refresh.
...
- [ ] Web/mobile parity design scope for core user journeys.
  - Acceptance criteria:
    - Browse â†’ play â†’ rate â†’ favorite behavior is documented for equivalence.
...
- [ ] Scope evidence documentation. [EVIDENCE COLLECTION DEFERRED FOR MVP â€” see Rule 118.]
  - Acceptance criteria:
