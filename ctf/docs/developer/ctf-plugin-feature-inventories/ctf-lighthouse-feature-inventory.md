...
- [ ] Web + Android parity design scope. [PARITY TESTING DEFERRED FOR MVP â€” see Rule 118.]
  - Acceptance criteria:
    - Parity-required flows are documented for post-MVP testing.
- [ ] Release readiness documentation. [EVIDENCE COLLECTION DEFERRED FOR MVP â€” see Rule 118.]
  - Acceptance criteria:
