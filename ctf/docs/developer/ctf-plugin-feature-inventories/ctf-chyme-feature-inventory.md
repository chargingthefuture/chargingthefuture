...
15. **Scheduled rooms, MVP: what is coming up on the TI Radio guide (owner decision, 2026-09-19).**
    ...
    entire of scheduled rooms for now: no room creation, no room per slot, no search — the rest of
...
9. **Closed by design (2026-09-19) — no in-app deletion entry point inside Chyme.** The Chyme
   ...
   place a member deletes a service or the entire account, and `DELETE /api/account/chyme-profile`
