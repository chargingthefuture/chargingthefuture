...
- 2026-08-08: **"Go live" failed every time because the recording settings were incomplete (owner
  ...
  refuses the entire request, which meant the call was never created and neither the phone (RTMP) nor
