...
- The old curated promotions list (`APPROVED_SKILL_PROMOTIONS` in `ctf/scripts/lib/seedSkillsTaxonomyPromotions.mjs` and its standalone runner) was **migrated into ops 1–25 and deleted** — do not look for or rebuild it; append ops instead.
