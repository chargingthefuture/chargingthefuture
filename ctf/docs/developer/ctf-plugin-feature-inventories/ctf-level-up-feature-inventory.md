...
- `POST /api/level-up/cohorts`
- `POST /api/level-up/enroll`
- `POST /api/level-up/milestones/[milestoneId]/validate`
- `POST /api/level-up/milestones/[milestoneId]/release`
- `POST /api/level-up/transfers`
- `POST /api/level-up/disputes`
- `POST /api/level-up/disputes/[disputeId]/resolve`
- `POST /api/level-up/admin/adjust-credits`
