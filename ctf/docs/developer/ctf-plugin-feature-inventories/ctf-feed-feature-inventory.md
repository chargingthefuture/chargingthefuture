...
### 3.1 Plugin Command Surface (Authoritative â€” Unified `feed.*` Namespace)
...
1. `feed.timeline.fetch` (v2.0.0 â€” supports channel filter)
...
- 2026-04-05: Added Phase 4 (Questions + LLM), Phase 5 (Community Support), Phase 6 (Android Parity â€” required). Renumbered security/compliance to Phase 7. All commands now use unified `feed.*` namespace per FEED_PLUGIN_COMMAND_CONTRACTS.yaml.
