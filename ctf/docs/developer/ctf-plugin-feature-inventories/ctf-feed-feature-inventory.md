...
**Community Support:** 15. `feed.community.post.create` 16. `feed.community.post.reply` 17. `feed.community.post.reaction.toggle` 18. `feed.community.post.delete` (author-only; delete your own post — there is no edit)
