...
- **Per-plugin participation (v3)** — one coarse COUNT each, completed/accepted/claimed states only, so a
  ...
  - SkillUp — `skill_up_enrollments` completed → "Completed N SkillUp cohorts"
