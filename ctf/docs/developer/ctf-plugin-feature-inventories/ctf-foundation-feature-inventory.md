...
- **Android:** delivered (pixel pass, 2026-05-31) for the search/quote/Direct Line surface. The instant 1:1 call ring/answer lifecycle AND per-block billing (issue #808 tasks 3 and 4) are **web + mobile-responsive web only**; React Native parity is deferred to the issue #808 Android follow-up. The mobile feature binds the real Foundation API — see below.
