...
2. **Attribution is the badge's attribution.** Value is credited to the member who delivered it — provider, host, fulfiller, sender, scout, author — which is what the badge has always counted. A ride credits its driver, so 384 here means 384 members delivering, not 384 people involved in something.
