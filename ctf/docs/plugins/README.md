# Plugin Artifact Hubs

This directory provides one folder per plugin with link-only indexes to canonical artifacts.
Canonical contract files remain under docs/contracts to preserve existing automation and policy paths.

## Plugin Hubs

- [Announcements](./announcements/README.md)
- [Chyme](./chyme/README.md)
...
- [LevelUp](./levelup/README.md)
- [LightHouse](./lighthouse/README.md)
- [Mood](./mood/README.md)
- [PeerProgramming](./peer-programming/README.md)
...
- [TrustTransport](./trusttransport/README.md)
- [Unlock](./unlock/README.md)
- [Weekly Performance](./weekly-performance/README.md)
