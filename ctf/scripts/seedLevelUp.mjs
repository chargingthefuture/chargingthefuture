...
const users = {
  admin: 'seed-level-up-admin',
  trainer: 'seed-level-up-trainer',
  trainee1: 'seed-level-up-trainee-01',
  trainee2: 'seed-level-up-trainee-02',
  trainee3: 'seed-level-up-trainee-03',
};
...
async function main() {
  ...
  try {
    ...
    await client.query(
      `INSERT INTO level_up_trainers (id, user_id, display_name, headline, bio, tracks, status)
    ...
    await client.query(
      `INSERT INTO level_up_achievements (id, slug, name, description, track, icon, credit_reward, sequence_no, status)
       VALUES
    ...
    await client.query(
      `INSERT INTO level_up_user_achievements (id, user_id, achievement_id, granted_credits, source_reference)
