...
- Never write a sentence whose job is to tell the reader which fact mattered ("that is the point", "which is the argument", "that was the point of the thing"). State the thing and stop.`;
