...
INSERT INTO ctf_plugin_registry (plugin_slug, display_name, summary, availability_state, nav_rank, is_visible) VALUES
  ...
  ('skills-hunt',        'Skills Hunt',          'Discover skills across the network.',                     'alpha',             60,  TRUE),
  ...
  ('levelup',            'LevelUp',              'Goal tracking and progress milestones. Your journey, documented and celebrated.','implemented_shell', 170, TRUE),
