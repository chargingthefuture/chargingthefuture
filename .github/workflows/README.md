...
| `generate-product-update.yml` | Generate — Product Update | Every 48 hours (00:33 UTC every other day); manual | Turns recent feat/fix/perf commits into a product update: publishes to the wiki, the blog registry, and the in-app feed, files a Quora draft issue, and tags the update. |
