...
| `generate-user-guide.yml` | User Guide — Regenerate | Mondays 06:00 UTC; manual | Regenerates the public user guide (`/guide` + `docs/USER_GUIDE.md`) from each plugin's inventory User Features section and test-script Core smoke steps, via `ctf/scripts/generate-user-guide.mjs`. |
