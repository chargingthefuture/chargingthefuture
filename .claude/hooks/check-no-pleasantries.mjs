...
const VOCABULARY = [
  ...
  // Owner directive, 2026-08-28. Both of these are the same tic: a sentence that arrives after the
  // facts to announce which one of them was the important one. It reads as insistence, it is used
